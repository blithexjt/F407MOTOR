...
extern u8 com1_rx_buffer[400];   //??????
extern u8 com1_recv_end_flag;


 double Current[16] = {100,93.75,87.5,81.25,75,68.75,62.5,56.25,50,43.75,37.5,31.25,25,18.75,12.5,6.25};
